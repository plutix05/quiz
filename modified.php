...
if ((!isset($_SESSION['modify_complete']))) {
    header('Location: pytania.php');
    exit();
} else {
    unset($_SESSION['modify_complete']);
}
...
<head>
    ...
    <title>Egzamin - modyfikowanie zakończone</title>
...
<body>
    <div id="container">
        ...
        <section>
            <form>
                <p>
                    Udało się zmodyfikować pytanie! Za <span id="timer">5</span> sek. zostaniesz przeniesiony do listy pytań. Jeżeli tak się nie stało kliknij w <a href="pytania.php">ten link</a>
                </p>
            </form>
        </section>
    </div>
